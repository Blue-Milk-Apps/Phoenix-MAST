...
from adapters.scanners.common import strings_scanner
...
def test_strings_scan_for_apk_returns_raw_output_for_multiple_targets(monkeypatch, tmp_path: Path) -> None:
    ...
    outputs_by_path = {result.relative_target_path: result.raw_output for result in results}
...
def test_strings_scan_for_ipa_paths_are_relative_to_app_bundle(monkeypatch, tmp_path: Path) -> None:
