...
def test_syft_scan_success_loads_raw_output(
    ...
    monkeypatch.setattr(
        syft_scanner.subprocess, "Popen", lambda cmd, *args, **kwargs: FakeProcess(cmd)
    )
...
def test_syft_scan_uses_configured_stdout_format(
